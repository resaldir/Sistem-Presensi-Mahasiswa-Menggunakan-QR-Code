...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                <a href="/ruangan" class="btn btn-primary btn-sm" alt="tambah" style="color: #a9fd00;background-color: #0a0a0a"><i class="glyphicon glyphicon-chevron-left" ></i></a> Create Ruangan
            </h1>
            <ol class="breadcrumb">
        ...
        <section class="content">
            ...
            <div class="row">
                ...
                <section class="col-lg-12">
                    ...
                    {!! Form::open(['class'=>'form-horizontal','action'=>'RuanganController@store','method'=>'POST']) !!}

                    <div class="form-group">
                        {!! Form::label('ruanganKode','Kode Ruangan',['class'=>'col-sm-2 control-label']) !!}
                        <div class="col-sm-8">
                            {!! Form::text('ruanganKode',null,['placeholder'=>'Kode Ruangan','class'=>'form-control']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            {!! Form::number('ruanganKapasitas',null) !!}
                        </div>
                    </div>
