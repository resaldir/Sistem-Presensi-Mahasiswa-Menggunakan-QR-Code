...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                <a href="/jadwal" class="btn btn-primary btn-sm" alt="tambah" style="color: #a9fd00;background-color: #0a0a0a"><i class="glyphicon glyphicon-chevron-left" ></i></a> Create Jadwal Kuliah
            </h1>
            <ol class="breadcrumb">
        ...
        <section class="content">
            ...
            <div class="row">
                ...
                <section class="col-lg-12">
                    ...
                    {!! Form::open(['class'=>'form-horizontal','action'=>'JadwalController@store','method'=>'POST']) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            {!! Form::select('hariId',$haris,null,['class'=>'form-control','placeholder'=>'Pilih Hari']); !!}
                        </div>
                    </div>

                    <div class="form-group">
                        {!! Form::label('sesi','Sesi',['class'=>'col-sm-2 control-label']) !!}
                        <div class="col-sm-8">
                            {!! Form::text('sesiMulai',null,['class'=>'form-control','placeholder'=>'jam:menit']);!!}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        {!! Form::label('sesi','Sesi',['class'=>'col-sm-2 control-label']) !!}
                        <div class="col-sm-8">
                            {!! Form::text('sesiSelesai',null,['class'=>'form-control','placeholder'=>'jam:menit']  );!!}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            {!! Form::select('ruanganId',$ruangans,null,['class'=>'form-control','placeholder'=>'Pilih Ruangan']); !!}
                        </div>
                    </div>
