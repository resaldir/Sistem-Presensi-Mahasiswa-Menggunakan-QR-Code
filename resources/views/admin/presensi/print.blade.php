            ...
            <tr>
                ...
                @foreach($presensi->where('mhsId',$krs->mhsId) as $per)
                    ...
                    @switch($per->presensiStatus)
                        @case(1)
                        <td class="text-center align-middle" style="vertical-align: middle">Hadir</td>
                        @break
                        @case(2)
                        <td class="text-center align-middle" style="vertical-align: middle">Izin</td>
                        @break
                        @default
                        <td class="text-center align-middle" style="vertical-align: middle">-</td>
                    @endswitch
                    {{--@else--}}
