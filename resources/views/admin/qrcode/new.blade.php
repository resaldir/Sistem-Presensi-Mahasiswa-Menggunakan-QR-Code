...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                <a href="/qrcode/{!! $qr->klsId !!}" class="btn btn-primary btn-sm" alt="tambah" style="color: #a9fd00;background-color: #0a0a0a"><i class="glyphicon glyphicon-chevron-left" ></i></a> New Qr Code
            </h1>
            <ol class="breadcrumb">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <section class="col-lg-offset-1 col-lg-10 ">
                        ...
                        <div class="row ">
                            <h5 style="text-align: center"><strong>Expired At : </strong>{!! $qrcode->qrcodeWaktuAkhir->format('H:i:m | d-m-Y') !!}</h5>
                        </div>
