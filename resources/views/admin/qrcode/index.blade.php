                                    ...
                                    @if(count($klss)>0)
                                        @foreach($klss as $kls)
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><a href="/qrcode/{{$kls->klsId}}" class="btn btn-xs" style="color: #a9fd00;background-color: #0a0a0a;"><i class="glyphicon glyphicon-align-justify"></i> Detail</a></td>
